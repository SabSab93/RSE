...
Dans un second temps (à ne pas lancer maintenant) je souhaite que tu crées un skill permettant suivant l’élément à auditer, de le corriger. Tu enclenches lorsque j'inscris ceci par exemple "/eco-audit17" (si c'est audit17 fournit à partir du résultat de la première étapes) et par la suite tu réalises ces étapes : 
- Etape 1 : Creer une branche dédiée pour cet audit au format /audit-eco-17
- Etape 2 : Récupérer les métriques (desktop et mobile) en utilisant Lighthouse EcoIndex, PageSpeed Insights afin de remplir le tableau ci-dessous; si il est impossible de récupérer des éléments, inscrire N/A. Tu dois récupérer: Poids Page en Mo, Nombre de requetes (au moment du chargement de page); EcoIndex; Score LightHouse; LCP; CLS
...
Mobile - Audit 17 – RWEB 0032- Favoriser les polices standards.
| Indicateur | Avant | Après | Gain |
|---|---:|---:|---:|
| Poids (Mo) | |  |  |
| Nombres requêtes |  |  |  |
